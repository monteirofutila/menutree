 ...
 <div class="card bg-white shadow-lg overflow-hidden relative">
     <div class="h-full">
         <img class="object-cover object-center w-full h-48 mx-auto" src="{{ asset('storage/' . $product->photo_url) }}"
             alt="avatar">
         <div class="p-2">
             <h1 class="text-base p-2 rounded-md hover:bg-gray-100 font-medium text-black leading-heading">
                 {{ $product->name }}</h1>
         </div>
     </div>
     <div class="flex items-center p-2 self-end justify-end w-full">
